...
class Nav2GoalBridgeNode(Node):
    def __init__(self) -> None:
        ...
        self._cancel_sub = self.create_subscription(
            Empty, self._cancel_topic, self._on_cancel, 10
        )
        ...
        self.get_logger().info(
            f"Nav2 goal bridge ready: goal_topic={self._goal_topic} "
    ...
    def _duration_to_seconds(self, duration_msg) -> Optional[float]:
